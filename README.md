...
44 connectors across 8 categories. 21 backed by production read-only API integrations. 23 are catalog-ready with demo evidence while awaiting live implementation. All connectors are locked to demo by default — live calls require an explicit allowlist.
